...
describe('Testing scrollDir-observable', function () {
    it("should have a scroll direction of 'down'", function (done) {
        function assertFn() {
            var obs$ = index_1.scrollDirObservable(window.document, window);
            obs$.subscribe(function (val) {
                chai_1.expect(val).to.eql('down');
            });
        }
        function scroll() {
        ...
        (function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, pupp.launch()];
                    case 1:
                        browser = _a.sent();
                    ...
                    case 4:
                        _a.sent(); // TODO: this thing causes problems for us!
                        return [4 /*yield*/, page.evaluate(scroll)];
                    case 5:
                        _a.sent();
